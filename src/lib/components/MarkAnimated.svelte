...
>
	...
	<div class="w-full flex mt-[35.714286%] h-[28.571429%] justify-center relative">
		<div class="w-[14.285714%] h-full bg-c-bg mr-[14.285714%] origin-bottom blink-animation" />
		<div class="w-[14.285714%] h-full bg-c-bg origin-bottom blink-animation" />
	</div>
	<div class="w-[150%] -ml-[25%] bg-c-bg h-[7.142857%] mt-[14.285714%] relative mouth-animation" />
</div>
